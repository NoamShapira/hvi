...
bsub -q gpu-long -R rusage[mem="$JOB_MEMORY_MB"] -gpu num=1 -oo "$JOB_LOGS_DIR" -R 'hname!=cn300 && hname!=cn301 && hname!=cn302 && hname!=cn303 && hname!=cn304 && hname!=cn736' bash "$PIPELINE_SCRIPT" "$HOST_PROTEIN" "$VIRUS_PROTEIN"
